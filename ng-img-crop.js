...
crop.factory('cropArea', ['cropCanvas', function(CropCanvas) {
  var CropArea = function(ctx, events) {
    ...
    this._minSize={x:0, y: 0, w:0, h:0};/*This is for minimum cropper selection size of canvas*/
                                        /* @author- bharat*/
                                        /*THis is default -> 'this._minSize={x:0, y: 0, w:0, h:0};'*/
  ...
  return function(elCanvas, opts, events){
    ...
    var resetCropHost=function() {
      if(image!==null) {
        ...
        if(canvasDims[1]>maxCanvasDims[1]) {
          ...
          /*@author-bharat - To set crop image selection at center position*/
        elCanvas.prop('width',260).prop('height',170).css({'margin-left': 5+'%', 'margin-top':3+'%'}); 
    ...
    this.setMaxDimensions=function(width, height) {
      ...
      if(image!==null) {
        ...
        elCanvas.prop('width',canvasDims[0]).prop('height',canvasDims[1]).css({'margin-left': 260+'px', 'margin-top': 170+'px'});
...
crop.directive('imgCrop', ['$timeout', 'cropHost', 'cropPubSub','$rootScope', function($timeout, CropHost, CropPubSub,$rootScope) {
  return {
    restrict: 'E',
    scope: {
      image: '=',
    ...
    link: function(scope, element/*, attrs*/) {
      ...
      var updateResultImage=function(scope) {
        ...
        if(storedResultImage!==resultImage) {
          ...
          /*console.log('My 1:'+storedResultImage);*/
          if(angular.isDefined(scope.resultImage)) {
            scope.resultImage=resultImage;
            $rootScope.saveCroppedImage=scope.resultImage;
              //console.log(scope.resultImage)
              
            /*console.log('My 2:'+scope.resultImage);*/
          }
